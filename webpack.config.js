...
const svgIconsPath = 'src/common/svg/icons';
        ...
        use: [
            {
                loader: 'file-loader',
                options: {
                    name: isDev ? 'fonts/[name].[ext]' : 'fonts/[name].[hash:5].[ext]',
                },
            },
        ],
    };
...
module.exports = {
    ...
    plugins: [
        ...
        new WebpackPwaManifest({
            name: 'BerryWallet',
            short_name: 'BerryWallet',
            description: 'BerryWallet Progressive Web App!',
            background_color: '#630fcd',
            theme_color: '#630fcd',
            icons: [
                {
                    src: path.resolve(__dirname, './src/client/images/logo-icon.png'),
                    sizes: [128, 512]
                },
            ],
            start_url: "/",
